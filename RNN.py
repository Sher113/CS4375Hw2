...
class RNN(nn.Module):
    def __init__(self, input_dim, h, embedding_dim):
        super(RNN, self).__init__()
        self.h = h
        self.embedding = nn.Embedding(input_dim, embedding_dim)
        self.rnn = nn.RNN(embedding_dim, h, batch_first=True)
        self.output_dim = 5
    ...
    def forward(self, input_sequence):
        ...
        embedded_seq = self.embedding(input_sequence)
        # Pass through the RNN
        rnn_out, _ = self.rnn(embedded_seq)
...
def convert_to_vector_representation(data, word2index):
    ...
    for document, y in data:
        ...
        vectorized_data.append((torch.tensor(indices), y))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--embedding_dim", type=int, default=50, help="Dimension of word embeddings")
    ...
    model = RNN(input_dim=len(vocab), h=args.hidden_dim, embedding_dim=args.embedding_dim)
